...
/***/ function(module, exports, __webpack_require__) {
	...
	var _ClassifierRouter = __webpack_require__(18);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _RootView = __webpack_require__(9);

	var _RootView2 = _interopRequireDefault(_RootView);

	var _MenuView = __webpack_require__(10);
	...
	var App = new _marionette2.default.Application({
	    ...
	    showNavigation: function showNavigation(view) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	(function(root, factory) {
	  ...
	  if (true) {
	    !(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__(5), __webpack_require__(2), __webpack_require__(7), __webpack_require__(8)], __WEBPACK_AMD_DEFINE_RESULT__ = function(Backbone, _) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.default = _marionette2.default.CompositeView.extend({
	    ...
	    initialize: function initialize() {
	        ...
	        menuLinks.add(new _MenuLinkViewModel2.default().set({
	            url: _GlobalVars2.default.SITE_URL + "", text: "Neumes"
	        }));
	        menuLinks.add(new _MenuLinkViewModel2.default().set({
	            url: _GlobalVars2.default.SITE_URL + "nomenclatures/", text: "Nomenclatures"
	        }));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _mainMenuLinkTemplate = __webpack_require__(12);
	...
	exports.default = _marionette2.default.ItemView.extend({
	    ...
	    goToUrl: function goToUrl(event) {
	        event.preventDefault();
	        _App2.default.appRouter.routeToPage(event.target.href);
	    }
		});
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.default = _marionette2.default.AppRouter.extend({
	    ...
	    openGlyphList: function openGlyphList() {
	        // Start the glyph list module
	        _App2.default.module("GlyphList").start();
	    },

	    openGlyphEditor: function openGlyphEditor(id) {
	        // Start the individual glyph editor
	        _App2.default.module("GlyphEdit").start();
	        _App2.default.module("GlyphEdit").initializeId(id);
	    },

	    openNomenclatureList: function openNomenclatureList() {
	        // Start the nomenclature list module
	        _App2.default.module("NomenclatureList").start();
	    },

	    openNomenclatureEdit: function openNomenclatureEdit(id) {
	        _App2.default.module("NomenclatureEdit").start();
	        _App2.default.module("NomenclatureEdit").initializeId(id);
	    },

	    routeToPage: function routeToPage(url) {
	        var newPageUrl = _GlobalVars2.default.SITE_SUBFOLDER + String(url).replace(/.*\/neumeeditor\//g, "");
	        this.navigate(
	        // Strip site url if need be
	        newPageUrl, { trigger: true });
	    }
		});
