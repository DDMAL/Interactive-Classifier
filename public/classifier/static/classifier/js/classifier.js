(function($){
    ...
    var SITE_URL = "/";
    var SITE_SUBFOLDER = "/";
    var STATIC_URL = "/classifier/media/";
    ...
    */
    ...
    App.module("NomenclatureEdit", function(NomenclatureEdit, App, Backbone, Marionette, $, _){
        ...
        this.initializeId = function(id)
        {
            ...
            var nomenclature = new Nomenclature({url: "/classifier/nomenclature/" + nomenclatureId + "/"});
    ...
    App.module("NomenclatureList", function(NomenclatureList, App, Backbone, Marionette, $, _){
        ...
        var NomenclatureDashboardView = Backbone.Marionette.LayoutView.extend({
            ...
            onShow: function() {
                var nomenclatureCollection = new NomenclatureCollection({url: "/classifier/nomenclatures/"});
    ...
    App.module("GlyphEdit", function(GlyphEdit, App, Backbone, Marionette, $, _){
        ...
        */
        ...
        {
            glyphId = parseInt(id);
            glyph.url = "/classifier/glyph/" + glyphId + "/";

            // Get the nomenclature list that we will use
            var nomenclatures = new NomenclatureCollection({url: "/classifier/nomenclatures"});
