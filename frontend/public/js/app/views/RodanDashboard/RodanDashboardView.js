...
var RodanDashboardView = Marionette.LayoutView.extend(
     ...
     */
    {
        ...
        resizeWindow: function (event, context)
        {
            ...
            if (context.isCollapsed !== $('#right0').attr("aria-expanded"))
            {
                this.resize = true;
                context.isCollapsed = $('#right0').attr("aria-expanded");
            }
            ...
            collapseButton.style.height = this.collapseHeight + "px";
            collapseButton.style.width = this.collapseWidth + "px";
            ...
            if (this.winWidth !== currentWinWidth)
            {
                // Width percentage
                var wPerc = this.winWidth / currentWinWidth;
                this.winWidth = currentWinWidth;
                this.classWidth = this.classWidth / wPerc;

                this.resize = true;
            }

            if (this.winHeight !== currentWinHeight)
            {
                // Height percentage
                var hPerc = this.winHeight / currentWinHeight;
                this.winHeight = currentWinHeight;

                this.classHeight = this.classHeight / hPerc;
                this.glyphHeight = this.glyphHeight / hPerc;

                this.resize = true;
            }

            // Makes sure the user actually resizes a window by checking this the mouse is on the resize button
            ...
            if (this.resize)
            {
                ...
                var heightPerc = currentHeight / this.classHeight;
                var widthPerc = currentWidth / this.classWidth;
                ...
                upper.style.width = Math.round((1 - widthPerc) * 100) + "%";
            }
        },
