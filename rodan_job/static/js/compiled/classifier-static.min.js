...
/***/ function(module, exports, __webpack_require__) {
	...
	var App = new _marionette2.default.Application({
	    ...
	    onStart: function onStart() {
	        ...
	        var shortCodesElement = (0, _jquery2.default)("#shortCodes");
	    ...
	    editPage: function editPage(glyphDictionary, imagePath, shortCodes) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _rodanDashboardTemplate = __webpack_require__(56);
...
/***/ function(module, exports, __webpack_require__) {
	...
	((__t=( short_code ))==null?'':_.escape(__t))+
	'" title="glyph-class" onfocus="this.value = this.value;">\n                        <button type="submit" class="btn btn-default">'+
	((__t=( gui.update ))==null?'':_.escape(__t))+
	'</button>\n                    </form>\n                </td>\n            </tr>\n            <tr>\n                <td>'+
	    ...
	    onMouseUp: function onMouseUp(event) {
	        ...
	        if (this.isMouseDown === true) {
	            ...
	            if (width !== 0 && height !== 0 && width * height > 10) {
	                ...
	                _RadioChannels2.default.edit.trigger(_GlyphEvents2.default.dragSelect, boundingBox, collection, isAdditional // If the shift key is held, then it's an "additional" selection!
	                );
	            }
	        }
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.default = _marionette2.default.ItemView.extend({
	    ...
	    initialize: function initialize(options) {
	        ...
	        var that = this;
	        this.listenTo(_RadioChannels2.default.edit, _GlyphEvents2.default.dragSelect, function (boundingBox, collection, additional) {
