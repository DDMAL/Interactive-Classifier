...
from classifier.views.name import NameList, NameDetail
from classifier.views.name_nomenclature_membership import \
    NameNomenclatureMembershipList, NameNomenclatureMembershipDetail, NameNomenclatureMembershipListForGlyph
from classifier.views.nomenclature import NomenclatureDetail, NomenclatureList, \
    NomenclatureNames
from classifier.views.style import StyleList, StyleDetail
from rest_framework.urlpatterns import format_suffix_patterns
from classifier.views.glyph import GlyphDetail, GlyphList, GlyphImages, \
    GlyphNames
