...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Glyph = __webpack_require__(30);
	...
	var _Authenticator = __webpack_require__(79);
	 ...
	 */
	{
	    ...
	    onBeforeStart: function onBeforeStart() {
	        ...
	        this.listenTo(_RadioChannels2.default.edit, _ClassEvents2.default.deleteClass, function (glyphModel) {
	            that.changedGlyphs.add(glyphModel);
	        });
	        ...
	        this.listenTo(_RadioChannels2.default.edit, _GlyphEvents2.default.deleteGlyph, function (glyphModel) {
	            that.deleteGlyph(glyphModel);
	        });

	        this.listenTo(_RadioChannels2.default.edit, _GlyphEvents2.default.deleteMultiGlyphs, function (glyphs) {
	    ...
	    */
	    ...
	    deleteMultipleGlyphs: function deleteMultipleGlyphs(glyphs) {
	        var that = this;
	        var data = JSON.stringify({
	            "multi_delete": true,
	            "glyphs": glyphs.toJSON()
...
/***/ function(module, exports, __webpack_require__) {
	...
	(function(root, factory) {
	  ...
	  if (true) {
	    !(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__(8), __webpack_require__(4), __webpack_require__(12), __webpack_require__(13)], __WEBPACK_AMD_DEFINE_RESULT__ = function(Backbone, _) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	(function(root, factory) {
	  ...
	  if (true) {
	    !(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__(8), __webpack_require__(4)], __WEBPACK_AMD_DEFINE_RESULT__ = function(Backbone, _) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _MenuLinkView = __webpack_require__(17);

	var _MenuLinkView2 = _interopRequireDefault(_MenuLinkView);

	var _MenuLinkViewModel = __webpack_require__(22);

	var _MenuLinkViewModel2 = _interopRequireDefault(_MenuLinkViewModel);

	var _MenuViewModel = __webpack_require__(16);
	...
	var _mainMenuTemplate = __webpack_require__(25);
	...
	exports.default = _marionette2.default.CompositeView.extend({
	    ...
	    initialize: function initialize() {
	        ...
	        menuLinks.add(new _MenuLinkViewModel2.default({
	            url: "#",
	            text: _Strings2.default.menuGroupLabel,
	            clickEvent: _MainMenuEvents2.default.clickGroupClassify
	        }));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _SubMenuView = __webpack_require__(18);

	var _SubMenuView2 = _interopRequireDefault(_SubMenuView);

	var _mainMenuLinkTemplate = __webpack_require__(21);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _SubMenuLinkView = __webpack_require__(19);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _mainMenuSubLinkTemplate = __webpack_require__(20);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _PageEvents = __webpack_require__(28);
	...
	var _ClassTreeView = __webpack_require__(32);
	...
	var _ClassEditView = __webpack_require__(42);
	...
	var _rodanDashboardTemplate = __webpack_require__(64);
	 ...
	 */
	{
	    ...
	    initialize: function initialize() {
	        ...
	        this.classifierRowCollection = new _GlyphTableRowCollection2.default();
	        ...
	        this.listenTo(_RadioChannels2.default.edit, _GlyphEvents2.default.deleteGlyph, function (glyph) {
	        ...
	        this.listenTo(_RadioChannels2.default.edit, _PageEvents2.default.zoom, function (zoomLevel) {
	        ...
	        this.listenTo(_RadioChannels2.default.edit, _GlyphEvents2.default.zoomGlyphs, function (zoomLevel) {
	        ...
	        this.listenTo(_RadioChannels2.default.edit, _GlyphEvents2.default.openMultiEdit, function () {
	            ...
	            // If only one glyph has been selected, then glyph edit will open
	                    ...
	                    glyph = glyphs.at(0);
	                    _RadioChannels2.default.edit.trigger(_GlyphEvents2.default.openGlyphEdit, glyph);
	                } else {
	    ...
	    onShow: function onShow() {
	        ...
	        (0, _jquery2.default)('#right0').collapse('toggle');
	        ...
	        (0, _jquery2.default)(document).mousemove(function (event) {
	            if (that.isMouseDown) {
	                ...
	                if (this.isCollapsed !== (0, _jquery2.default)('#right0').attr("aria-expanded")) {
	                    that.resize = true;
	                    this.isCollapsed = (0, _jquery2.default)('#right0').attr("aria-expanded");
	                }
	     ...
	     */
	    openClassEdit: function openClassEdit(model) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _ClassNameUtils = __webpack_require__(31);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _classNameArrayToRecursiveTree = __webpack_require__(33);
	    ...
	    initialize: function initialize() {
	        ...
	        this.listenTo(_RadioChannels2.default.edit, _GlyphEvents2.default.setGlyphName, function (newClassName) {
	            ...
	            var filteredList = classNameList.filter(function (name) {
	                return !name.startsWith(deletedClassName);
	            });
	            // Set the new list
	            that.model = new _ClassTreeViewModel2.default({
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _recursiveUnorderedListTemplate = __webpack_require__(36);
	 ...
	 */
	{
	     ...
	     */
	    onRightClickName: function onRightClickName(rightClickEvent) {
	        ...
	        if (renameElem) {
	            var tmpClass = new _Class2.default({
	                name: className
	            });
	            _RadioChannels2.default.edit.trigger(_ClassEvents2.default.openClassEdit, tmpClass);
	        }
	    },
...
/***/ function(module, exports, __webpack_require__) {
	 ...
	 */
	{
	    ...
	    delete: function _delete(event) {
	        ...
	        _RadioChannels2.default.edit.trigger(_GlyphEvents2.default.deleteGlyph, this.model);
	    },
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _classEditTemplate = __webpack_require__(43);
...
/***/ function(module, exports, __webpack_require__) {
	 ...
	 */
	{
	    ...
	    delete: function _delete(event) {
	        ...
	        if (confirm(_Strings2.default.deleteWarning)) {
	            var glyphs = [];
	            this.collection.each(function (model) {
	                glyphs.push(model);
	            });
	            _RadioChannels2.default.edit.trigger(_GlyphEvents2.default.deleteMultiGlyphs, glyphs);
	        }
	    },
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _trainingEditTemplate = __webpack_require__(50);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _GlyphTableRowView = __webpack_require__(52);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _GlyphTableItemView = __webpack_require__(53);

	var _GlyphTableItemView2 = _interopRequireDefault(_GlyphTableItemView);

	var _tableRowTemplate = __webpack_require__(57);
	...
	exports.default = _marionette2.default.LayoutView.extend({
	    ...
	    initialize: function initialize(options) {
	        ...
	        this.listenTo(_RadioChannels2.default.edit, _GlyphEvents2.default.deleteMultiGlyphs, function (deletedGlyphs) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _GlyphTableItemViewModel = __webpack_require__(54);
	...
	var _tableGlyphTemplate = __webpack_require__(55);

	var _tableGlyphTemplate2 = _interopRequireDefault(_tableGlyphTemplate);

	var _Geometry = __webpack_require__(56);
	 ...
	 */
	{
	    ...
	    initialize: function initialize(options) {
	        ...
	        var that = this;
	        this.listenTo(_RadioChannels2.default.edit, _GlyphEvents2.default.dragSelect, function (boundingBox, additional) {
	            if (boundingBox) {
	        ...
	        this.listenTo(_RadioChannels2.default.edit, _GlyphEvents2.default.deleteGlyph, function (model) {
	            var elems = Array.from(document.getElementsByClassName("glyph img-thumbnail bg-warning glyph-image"));
	            elems.concat(Array.from(document.getElementsByClassName("glyph img-thumbnail bg-success glyph-image")));
	            for (var i = 0; i < elems.length; i++) {
	    ...
	    onClickGlyph: function onClickGlyph(event) {
	        ...
	        if (event.shiftKey) {
	            ...
	            _RadioChannels2.default.edit.trigger(_GlyphEvents2.default.dragSelect);
	            _RadioChannels2.default.edit.trigger(_GlyphEvents2.default.openMultiEdit);
	        } else {
	            _RadioChannels2.default.edit.trigger(_GlyphEvents2.default.switchGlyphActivation, this.model.attributes.id, true);
	            _RadioChannels2.default.edit.trigger(_GlyphEvents2.default.deselectAllGlyphs);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _imagePreviewTemplate = __webpack_require__(61);
	        ...
	        if (this.isSlider && this.isMouseDown === true) // If the coords of the click are on the slider
	            {
	                ...
	                _RadioChannels2.default.edit.trigger(_PageEvents2.default.zoom, value);
	                _RadioChannels2.default.edit.trigger(_GlyphEvents2.default.openMultiEdit);
	                console.log("MouseUp!");
	                this.isMouseDown = false;
	        ...
	        (0, _jquery2.default)(document).keypress(function (event) {
	            ...
	            if (that.isHover) {
	                if (event.key === "=") {
	                    ...
	                    slider.value = newVal;
	                    _RadioChannels2.default.edit.trigger(_PageEvents2.default.zoom, newVal);
	                } else if (event.key === "-") {
	                    newVal = value / 1.1;
	                    slider.value = newVal;
	                    _RadioChannels2.default.edit.trigger(_PageEvents2.default.zoom, newVal);
	            ...
	            if (that.isMouseDown === true) {
	                ...
	                if (event.buttons === 0) {
	                ...
	                } else if (that.isSlider) // If the coords of the click are on the slider
	                    {
	                        ...
	                        _RadioChannels2.default.edit.trigger(_PageEvents2.default.zoom, value);
	                        _RadioChannels2.default.edit.trigger(_GlyphEvents2.default.zoomGlyphs, value2);
	                    } else {
	                    var x = event.pageX,
	                        y = event.pageY;
...
/***/ function(module, exports, __webpack_require__) {
	...
	'" class="preview-background">\n<div class="preview-highlight"></div>\n<div id="zoom-slider" style="z-index: 2; position: fixed; width: 175px; "><input id="s1" type="range" min="10" max="110" step="0.1" value="60" default="60"/></div>\n<div id="glyph-zoom" style="z-index: 3; position: fixed; width: 175px; "><input id="s2" type="range" min="5" max="200" step="0.1" value="100" default="100"/></div>';
	}
	return __p;
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _ModalView = __webpack_require__(67);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _modalTemplate = __webpack_require__(68);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _loadingScreenTemplate = __webpack_require__(70);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _confirmTemplate = __webpack_require__(74);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _modifySettingsTemplate = __webpack_require__(78);
