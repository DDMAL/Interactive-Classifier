	 ...
	 */
	{
	    ...
	    zoomIn: function zoomIn(event) {
	        ...
	        if (this.zoomCount < this.maxZoomCount) {
	            _RadioChannels2.default.edit.trigger(_GlyphEvents2.default.zoomGlyphs, this.zoomLevel, this.zoomCount);
	        }
	    },
...
/***/ function(module, exports, __webpack_require__) {
	 ...
	 */
	{
	    ...
	    initialize: function initialize(options) {
	        ...
	        this.listenTo(_RadioChannels2.default.edit, _GlyphEvents2.default.selectGlyph, function (glyphModel) {
	            // jscs:disable
	            _RadioChannels2.default.edit.trigger(_GlyphEvents2.default.switchGlyphActivation, glyphModel.attributes.id, true);
	            // jscs:enable
	        });
	        ...
	        this.listenTo(_RadioChannels2.default.edit, _GlyphEvents2.default.zoomGlyphs, function (zoomLevel, zoomCount) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var __t,__p='',__j=Array.prototype.join,print=function(){__p+=__j.call(arguments,'');};
	with(obj||{}){
	__p+='<button id="image-out" class="image-zoom">-</button>\n<button id="image-in" class="image-zoom">+</button>\n<img src="'+
