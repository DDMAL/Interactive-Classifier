...
from classifier.helpers.file_system_utils import media_url_to_system_path, \
    remove_media_url
...
class Image(models.Model):
    ...
    glyph = models.ForeignKey("classifier.Glyph", null=True)
...
def save_thumbnails(sender, instance, **kwargs):
    ...
    image.thumbnail(get_thumbnail_dimensions(width, height),
