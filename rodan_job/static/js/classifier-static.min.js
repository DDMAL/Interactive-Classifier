...
/***/ function(module, exports, __webpack_require__) {
	...
	var _NavigationManager = __webpack_require__(72);
	...
	_App2.default.on('start', function () {
	    ...
	    if (titleElem && window.location.pathname !== '/') _NavigationManager2.default.registerPage({ navbarTitle: titleElem.textContent });else _NavigationManager2.default.registerPage({});
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _RadioChannels = __webpack_require__(6);
	...
	var _RootView = __webpack_require__(11);
	...
	var App = new _marionette2.default.Application({
	    ...
	    onBeforeStart: function onBeforeStart() {
	        ...
	        // Menuchannel
	        var that = this;
	        _RadioChannels2.default.menu.on(_MainMenuEvents2.default.clickSubmitCorrections, function () {
	            that.modals.submitCorrections.open();
	        });
	        _RadioChannels2.default.menu.on(_MainMenuEvents2.default.clickFinalizeCorrections, function () {
	            that.modals.finalizeCorrections.open();
	        });
	        _RadioChannels2.default.edit.on(_GlyphEvents2.default.changeGlyph, function (glyphModel) {
	    ...
	    onStart: function onStart() {
	        ...
	        setTimeout(function () {
	            ...
	            var glyphCollection = new _GlyphCollection2.default(glyphs);
	            // Open the view to edit the page
	            that.editPage(glyphCollection, binaryPageImage);
	        }, 1000);
	    },

	    editPage: function editPage(glyphCollection, image_path) {
	        var page = new _Page2.default({
	            binary_image: image_path
	        });

	        this.rootView.container.show(new _RodanDashboardView2.default({
	            model: page,
	    ...
	    initializeModals: function initializeModals() {
	        ...
	        this.rootView.modal.show(new _ModalCollectionView2.default({
	        ...
	        this.modals.finalizeCorrections = new _ModalViewModel2.default({
	            ...
	            innerView: new _ConfirmView2.default({
	                model: new _ConfirmViewModel2.default({
	                    text: _Strings2.default.finalizeWarning,
	                    callback: function callback() {
	                        // Once the user confirms, submit the corrections.
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.default = {
	    ...
	    globalUI: _backbone2.default.channel("globalUI"),
...
/***/ function(module, exports, __webpack_require__) {
	...
	(function (global, factory) {
	   true ? module.exports = factory(__webpack_require__(2), __webpack_require__(5)) : typeof define === "function" && define.amd ? define(["underscore", "backbone"], factory) : global.Backbone.Radio = factory(global._, global.Backbone);
...
/***/ function(module, exports, __webpack_require__) {
	...
	(function(root, factory) {
	  ...
	  if (true) {
	    !(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__(5), __webpack_require__(2), __webpack_require__(9), __webpack_require__(10)], __WEBPACK_AMD_DEFINE_RESULT__ = function(Backbone, _) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _MenuLinkView = __webpack_require__(14);

	var _MenuLinkView2 = _interopRequireDefault(_MenuLinkView);

	var _MenuLinkViewModel = __webpack_require__(19);

	var _MenuLinkViewModel2 = _interopRequireDefault(_MenuLinkViewModel);

	var _MenuViewModel = __webpack_require__(13);
	...
	var _mainMenuTemplate = __webpack_require__(22);
	...
	exports.default = _marionette2.default.CompositeView.extend({
	    ...
	    initialize: function initialize() {
	        ...
	        menuLinks.add(new _MenuLinkViewModel2.default({
	            url: "#",
	            text: _Strings2.default.menuSubmitLabel,
	            clickEvent: _MainMenuEvents2.default.clickSubmitCorrections
	        }));
	        menuLinks.add(new _MenuLinkViewModel2.default({
	            url: "#",
	            text: _Strings2.default.menuFinalizeLabel,
	            clickEvent: _MainMenuEvents2.default.clickFinalizeCorrections
	        }));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _SubMenuView = __webpack_require__(15);

	var _SubMenuView2 = _interopRequireDefault(_SubMenuView);

	var _mainMenuLinkTemplate = __webpack_require__(18);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _SubMenuLinkView = __webpack_require__(16);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _mainMenuSubLinkTemplate = __webpack_require__(17);
...
/***/ function(module, exports, __webpack_require__) {
	...
	__p+='dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false';
	 } 
	__p+='">'+
	((__t=( text ))==null?'':__t)+
...
/***/ function(module, exports, __webpack_require__) {
	...
	var __t,__p='',__j=Array.prototype.join,print=function(){__p+=__j.call(arguments,'');};
	with(obj||{}){
	__p+='<nav class="navbar navbar-default navbar-fixed-top navbar-inverse" role="navigation">\n    <div class="navbar-header">\n        <button type="button" class="navbar-toggle" data-toggle="collapse" data-target="#bs-example-navbar-collapse-1">\n            <span class="sr-only">Toggle navigation</span>\n            <span class="icon-bar"></span>\n            <span class="icon-bar"></span>\n            <span class="icon-bar"></span>\n        </button>\n        <a class="navbar-brand" href="#">'+
	((__t=( title ))==null?'':__t)+
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _ClassTreeView = __webpack_require__(35);

	var _ClassTreeView2 = _interopRequireDefault(_ClassTreeView);

	var _ClassTreeViewModel = __webpack_require__(41);

	var _ClassTreeViewModel2 = _interopRequireDefault(_ClassTreeViewModel);

	var _GlyphEditView = __webpack_require__(42);

	var _GlyphEditView2 = _interopRequireDefault(_GlyphEditView);

	var _GlyphMultiEditView = __webpack_require__(44);

	var _GlyphMultiEditView2 = _interopRequireDefault(_GlyphMultiEditView);

	var _GlyphTableView = __webpack_require__(24);

	var _GlyphTableView2 = _interopRequireDefault(_GlyphTableView);

	var _GlyphTableRowViewModel = __webpack_require__(49);

	var _GlyphTableRowViewModel2 = _interopRequireDefault(_GlyphTableRowViewModel);

	var _GlyphTableViewModel = __webpack_require__(50);

	var _GlyphTableViewModel2 = _interopRequireDefault(_GlyphTableViewModel);

	var _GlyphTableRowCollection = __webpack_require__(51);

	var _GlyphTableRowCollection2 = _interopRequireDefault(_GlyphTableRowCollection);

	var _ImagePreviewView = __webpack_require__(52);

	var _ImagePreviewView2 = _interopRequireDefault(_ImagePreviewView);

	var _ImagePreviewViewModel = __webpack_require__(54);
	...
	var _rodanDashboardTemplate = __webpack_require__(55);
	...
	exports.default = _marionette2.default.LayoutView.extend({
	    ...
	    onShow: function onShow() {
	        ...
	        var previewView = new _ImagePreviewView2.default({
	        ...
	        var tableRowCollection = new _GlyphTableRowCollection2.default();
	        ...
	        this.listenTo(_RadioChannels2.default.edit, _GlyphEvents2.default.moveGlyph, function (glyph, oldShortCode, newShortCode) {
	            tableRowCollection.moveGlyph(glyph, oldShortCode, newShortCode);
	        });
	        this.listenTo(_RadioChannels2.default.edit, _GlyphEvents2.default.dragSelect, function (boundingBox, collection) {
	            that.openMultiGlyphEdit(collection);
	        });

	        var shortCodes = _underscore2.default.uniq(this.collection.pluck("short_code")).sort();
	        // Show the tree
	        var ctvm = new _ClassTreeViewModel2.default({
	            short_codes: shortCodes
	        });
	        this.glyphTreeRegion.show(new _ClassTreeView2.default({ model: ctvm }));

	        var glyphCollections = {};
	        // Separate the glyphs by their class
	        for (var i = 0; i < shortCodes.length; i++) {
	            glyphCollections[shortCodes[i]] = new _GlyphCollection2.default();
	        }

	        // Add the glyphs to the glyph collections
	        _underscore2.default.each(this.collection.toArray(), function (element) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _GlyphTableRowView = __webpack_require__(25);
	...
	exports.default = _marionette2.default.CollectionView.extend({
	    ...
	    initialize: function initialize() {
	        ...
	        var clearPrevViewModels = function clearPrevViewModels() {
	            _underscore2.default.each(prevViewModelSet, function (vm) {
	                vm.deactivate();
	            });
	        };

	        this.listenTo(_RadioChannels2.default.edit, _GlyphEvents2.default.openGlyphEdit, function (model, viewModel) {
	            clearPrevViewModels();
	    ...
	    onMouseUp: function onMouseUp(event) {
	        ...
	        if (this.isMouseDown === true) {
	            ...
	            if (width !== 0 && height !== 0 && width * height > 10) {
	                ...
	                _RadioChannels2.default.edit.trigger(_GlyphEvents2.default.dragSelect, boundingBox, collection);
	            }
	        }
	    ...
	    getAllGlypItemViews: function getAllGlypItemViews() {
	        var collection = [];
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _GlyphTableItemView = __webpack_require__(26);

	var _GlyphTableItemView2 = _interopRequireDefault(_GlyphTableItemView);

	var _tableRowTemplate = __webpack_require__(31);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _GlyphTableItemViewModel = __webpack_require__(28);
	...
	var _tableGlyphTemplate = __webpack_require__(29);

	var _tableGlyphTemplate2 = _interopRequireDefault(_tableGlyphTemplate);

	var _Geometry = __webpack_require__(30);
	...
	exports.default = _marionette2.default.ItemView.extend({
	    ...
	    initialize: function initialize(options) {
	        ...
	        var that = this;
	        _RadioChannels2.default.edit.on(_GlyphEvents2.default.dragSelect, function (boundingBox, collection) {
	        ...
	        _RadioChannels2.default.edit.on(_GlyphEvents2.default.openGlyphEdit, function (model) {
	            if (that.model !== model) {
	                that.viewModel.deactivate();
	            }
	        });
...
/***/ function(module, exports, __webpack_require__) {
	...
	with(obj||{}){
	__p+='<div class="'+
	((__t=( outerTag ))==null?'':__t)+
	'" style="padding: 5px; border: 1px solid #aaaaaa">\n    <a href="/glyph/'+
	((__t=( id ))==null?'':__t)+
	'/" class="glyph img-thumbnail '+
	((__t=( cssTag ))==null?'':__t)+
	'" style="width: 100%; min-height:50px">\n        <img src="data:image/png;base64,'+
	((__t=( image_b64 ))==null?'':__t)+
	'" alt="'+
	((__t=( short_code ))==null?'':__t)+
	'" width="'+
	((__t=( ncols ))==null?'':__t)+
	'" height="'+
	((__t=( nrows ))==null?'':__t)+
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Glyph = __webpack_require__(33);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _ShortCodeUtils = __webpack_require__(34);

	var _ShortCodeUtils2 = _interopRequireDefault(_ShortCodeUtils);
	...
	exports.default = _backbone2.default.Model.extend({
	    ...
	    changeClass: function changeClass(newShortCode) {
	        var oldShortCode = this.get("short_code");

	        // do the sanitization step
	        var sanitizedShortCode = _ShortCodeUtils2.default.sanitizeShortCode(newShortCode);
	        ...
	        _RadioChannels2.default.edit.trigger(_GlyphEvents2.default.moveGlyph, this, oldShortCode, this.get("short_code"));
	        _RadioChannels2.default.edit.trigger(_GlyphEvents2.default.changeGlyph, this);
	        _RadioChannels2.default.edit.trigger(_GlyphEvents2.default.setGlyphName, this.get("short_code"));
	    }
		});
...
/***/ function(module, exports) {
	...
	exports.default = {
	     ...
	     * @returns {*}
	     */
	    sanitizeShortCode: function sanitizeShortCode(input) {
	        // Lowercase
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _shortCodeArrayToRecursiveTree = __webpack_require__(36);

	var _shortCodeArrayToRecursiveTree2 = _interopRequireDefault(_shortCodeArrayToRecursiveTree);

	var _RecursiveUnorderedListView = __webpack_require__(37);

	var _RecursiveUnorderedListView2 = _interopRequireDefault(_RecursiveUnorderedListView);

	var _RecursiveUnorderedListViewModel = __webpack_require__(39);

	var _RecursiveUnorderedListViewModel2 = _interopRequireDefault(_RecursiveUnorderedListViewModel);

	var _classTreeTemplate = __webpack_require__(40);
	...
	exports.default = _marionette2.default.LayoutView.extend({
	    ...
	    initialize: function initialize() {
	        var that = this;
	        _RadioChannels2.default.edit.on(_GlyphEvents2.default.setGlyphName, function (newShortCode) {
	            console.log("Set name to ", newShortCode);
	            // Add the model to the short_codes
	            var oldShortCodeList = that.model.get("short_codes");
	            var newShortCodeList = _underscore2.default.union(oldShortCodeList, [newShortCode]);
	    ...
	    showSubTree: function showSubTree() {
	        ...
	        (0, _shortCodeArrayToRecursiveTree2.default)(shortCodes, mod);
...
/***/ function(module, exports) {
	...
	exports.default = function (shortCodes, root) {
	    // Split up the shortcodes by periods
	    var splitShortCodes = shortCodes.map(function (shortCode) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _recursiveUnorderedListTemplate = __webpack_require__(38);
	...
	exports.default = _marionette2.default.ItemView.extend({
	    ...
	    onClickNode: function onClickNode(event) {
	        ...
	        _RadioChannels2.default.edit.trigger(_GlyphEvents2.default.clickGlyphName, shortCode);
	    },
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _glyphEditTemplate = __webpack_require__(43);
	...
	exports.default = _marionette2.default.ItemView.extend({
	    ...
	    initialize: function initialize() {
	        var that = this;
	        this.listenTo(_RadioChannels2.default.edit, _GlyphEvents2.default.clickGlyphName, function (shortCode) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	((__t=( image_b64 ))==null?'':__t)+
	'" alt="Glyph Preview" class="img-thumbnail">\n    </div>\n    <div class="col-xs-6 col-md-9">\n        <table class="table table-hover">\n            <tr>\n                <td>Class</td>\n                <td>\n                    <form class="form-inline">\n                        <input type="text" class="form-control" value="'+
	((__t=( short_code ))==null?'':__t)+
	'" title="glyph-class" onfocus="this.value = this.value;">\n                        <button type="submit" class="btn btn-default">Update</button>\n                    </form>\n                </td>\n            </tr>\n            <tr>\n                <td>Manual ID</td>\n                <td>'+
	((__t=( id_state_manual ))==null?'':__t)+
	'</td>\n            </tr>\n            <tr>\n                <td>Confidence</td>\n                <td>'+
	((__t=( confidence ))==null?'':__t)+
	'</td>\n            </tr>\n            <tr>\n                <td>Position</td>\n                <td>('+
	((__t=( ulx ))==null?'':__t)+
	', '+
	((__t=( ulx ))==null?'':__t)+
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _GlyphMultiEditThumbnailList = __webpack_require__(45);
	...
	var _glyphMultiEditTemplate = __webpack_require__(48);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _GlyphMultiEditThumbnail = __webpack_require__(46);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _thumbnailTemplate = __webpack_require__(47);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var __t,__p='',__j=Array.prototype.join,print=function(){__p+=__j.call(arguments,'');};
	with(obj||{}){
	__p+='<p>\n    <form class="form-inline">\n        <input type="text" class="form-control" value="" title="glyph-class" onfocus="this.value = this.value;">\n        <button type="submit" class="btn btn-default">Update All Selected</button>\n    </form>\n</p>\n<div class="thumbnail-list"></div>';
	}
	return __p;
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.default = _backbone2.default.Model.extend({
	    defaults: {
	        spriteSheetUrl: "#",
	        selection: new _backbone2.default.Collection()
	    }
		});
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.default = _backbone2.default.Collection.extend({
	     ...
	     * @param newShortCode
	     */
	    moveGlyph: function moveGlyph(glyph, oldShortCode, newShortCode) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _imagePreviewTemplate = __webpack_require__(53);
	...
	exports.default = _marionette2.default.ItemView.extend({
	    ...
	    highlightGlyph: function highlightGlyph(glyph) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _ModalView = __webpack_require__(58);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _modalTemplate = __webpack_require__(59);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _loadingScreenTemplate = __webpack_require__(61);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _BaseModel = __webpack_require__(64);
	...
	exports.default = _BaseModel2.default.extend({
	    ...
	    getClassesUrl: function getClassesUrl() {
	     ...
	     */
	    guessAll: function guessAll(onSuccess) {
	        return _backbone2.default.ajax(this.get("url") + "guess/all/", {
	            method: "GET",
	            success: onSuccess
	        });
	    },
	     ...
	     * @param onSuccess
	     */
	    resetAll: function resetAll(onSuccess) {
	        return _backbone2.default.ajax(this.get("url") + "reset/all/", {
	            method: "GET",
	            success: onSuccess
	        });
	    }
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.default = _backbone2.default.Model.extend({
	     ...
	     * @returns {string}
	     */
	    getRelativeUrl: function getRelativeUrl() {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _confirmTemplate = __webpack_require__(67);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var NavigationManagerClass = _marionette2.default.Object.extend({
	    initialize: function initialize() {
	        this.navItems = new _backbone2.default.Collection(null, { sorted: false });

	        this.titling = new _backbone2.default.Model({
	            defaults: {
	                title: null,
	                navbarTitle: null
	            }
	    ...
	    registerPage: function registerPage(options) {
	        var titleSettings = _underscore2.default.defaults(options, { title: null });

	        if (titleSettings.navbarTitle === undefined) titleSettings.navbarTitle = titleSettings.title;

	        this.titling.set(titleSettings);
	    }
	});

		exports.default = new NavigationManagerClass();

/***/ }
/******/ ]);
//# sourceMappingURL=classifier-static.min.js.map